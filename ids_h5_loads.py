...
from scapy.layers.inet import IP, TCP, UDP  # Import protocol layers
...
model = tf.keras.models.load_model("iot_ids_model.h5")
...
def detect_packet(packet):
    ...
    print(prediction)
    if prediction[0] > 0.9:  # Assuming binary classification
